({
    ...
    addPreCallPlannerTemplate: function(cmp) {
        ...
        console.log('preCallPlanner obj Secondary_Objective__c: ', cmp.get('v.preCallPlanner').Secondary_Objective__c);
        ...
        console.log('preCallPlanner obj Secondary_Objective__c: ', cmp.get('v.preCallPlanner').Secondary_Objective__c);
        console.log('preCallPlanner obj Secondary_Objective__c: ', preCallPlanner.Secondary_Objective__c);
    ...
    _upsertPreCallPlanner: function(cmp, preCallPlanner, shouldRefresh) {
        ...
        function upsertPreCallPlannerCallback(response) {
            ...
            if(state === 'SUCCESS') {
                var returnVal = response.getReturnValue();
                console.log('returnVal: ', returnVal.Secondary_Objective__c);
