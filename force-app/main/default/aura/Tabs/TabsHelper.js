({
    ...
    update: function update(component) {
        ...
        if (tabsClass) {
            ...
            var gen_a_class = 'slds-tabs--' + component.get('v.type') + '__link';
            component.set('v.gen_a_class', gen_a_class);

            var gen_li_class = 'slds-text-title--caps slds-tabs--' + component.get('v.type') + '__item';
            component.set('v.gen_li_class', gen_li_class);
        }
