({
    handleAccountChange: function(cmp, event, helper) {
        ...
        console.log(' acc.Delta_YTD_Sales_Year_to_Year__c / acc.SAP_YTD_Sales__c: ', acc.Delta_YTD_Sales_Year_to_Year__c, acc.SAP_YTD_Sales__c, acc.Delta_YTD_Sales_Year_to_Year__c / acc.SAP_YTD_Sales__c);
