 ...
 */
	renderRoute: function renderRoute(cmp, e, h, routePath, routeParams) {
		var componentName = cmp.get('v.component'),
		    hasRouteParams = cmp.get('v.hasRouteParams');
		if (!routeParams) routeParams = {};
		if (componentName) {
           
			console.log('createComponent invoked', { componentName: componentName, routeParams: routeParams, newComponentHandler: newComponentHandler });
		...
		function newComponentHandler(newCmp) {
			console.log('createComponent handler invoked');
			if (cmp.isValid()) {
 ...
 */
	unrenderRoute: function unrenderRoute(cmp, e, h) {
 ...
 */
	getRouteParams: function getRouteParams(routePath, pathWithParams) {
