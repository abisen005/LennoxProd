({
    ...
    */
    handleRouteChangeAttempt: function handleRouteChangeAttempt(cmp, e, h) {
    ...
    */
    handleRouteChangeSuccess: function handleRouteChangeSuccess(cmp, e, h) {
    ...
    */
    handleRouteNavBack: function handleRouteNavBack(cmp, e, h) {
        var routerName = cmp.get('v.name'),
            eventRouterName = e.getParam('routerName') || '';
        if (routerName === eventRouterName) {
    ...
    *				for the target Route.
    */
    handleRouteNavForward: function handleRouteNavForward(cmp, e, h) {
        var routerName = cmp.get('v.name'),
            eventRouterName = e.getParam('routerName') || '';
        if (routerName === eventRouterName) {
            var newHistoryIndex = cmp.get('v.historyIndex') + 1,
    ...
    *				for the target Route.
    */
    handleRouteHistoryChange: function handleRouteHistoryChange(cmp, e, h) {
        var routerName = cmp.get('v.name'),
            eventRouterName = e.getParam('routerName');
        if (routerName === eventRouterName) {
