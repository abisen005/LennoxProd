    ...
    _donutChart.prototype = {
        build: function() {
            ...
            if(this.label.length > 0) {
                this.chartLabel = this.chartSVG
                    .append("text")
                    .attr('x', this.outerHeight / 2)
                    .attr('y', this.outerWidth / 2)
                    .attr('text-anchor', 'middle')
                    .attr('alignment-baseline', 'middle')
                    .attr('class', self.labelClass)
                    .text(self.label);
            }
            
            if(this.subLabel.length > 0) {
                this.chartSubLabel = this.chartSVG
                    .append("text")
                    .attr('x', this.outerWidth / 2)
                    .attr('y', this.outerHeight / 2 + 15)
                    .attr('text-anchor', 'middle')
                    .attr('alignment-baseline', 'before-edge')
                    .attr('class', self.subLabelClass)
                    .text(self.subLabel);
            }
